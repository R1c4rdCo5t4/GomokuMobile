...
class LeaderboardNavigationTest {
    ...
    @Test
    fun leaderboard_screen_to_home_screen_by_pressing_tab_button() {
        // Arrange
    ...
    @Test
    fun leaderboard_screen_to_leaderboard_screen_by_pressing_tab_button() {
        // Arrange
        testRule.assertContentExists(
    ...
    @Test
    fun leaderboard_screen_to_info_screen_by_pressing_tab_button() {
        // Arrange
        testRule.assertContentExists(
